...
hn.drop(columns = {'timestamp','admin_contact_name','admin_contact_email','country','partners','needs','notes'}, inplace=True)
...
cn.drop(columns = {'ein','ntee','address'}, inplace=True)
